...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC1 (6144 * SZ_1K)  // (5000 * SZ_1K)  //(9900 * SZ_1K)
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_PMEM (5632 * SZ_1K) // (2048 * SZ_1K) //(5632 * SZ_1K)(5550 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_GPU1 (3584 * SZ_1K) // (3300 * SZ_1K) //(3300 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_ADSP (1536 * SZ_1K) // (1500 * SZ_1K) //(1500 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_TEXTSTREAM (3072 * SZ_1K) //(3000 * SZ_1K) //(3000 * SZ_1K)
#endif
